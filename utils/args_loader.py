...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=int,
        default=500,
        help="Run dreambooth validation every X steps.",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
    ...
    parser.add_argument("--boft_dropout", type=float, default=0.1, help="BOFT dropout")
    parser.add_argument(
        "--boft_bias",
        type=str,
        default="none",
        help="Bias type for BOFT. Can be 'none', 'all' or 'boft_only'",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Flag to stop memory allocation tracing during training.",
    )
    ...
    parser.add_argument("--wandb_key", type=str, default=None, help="API key for wandb login")
    parser.add_argument("--wandb_project_name", type=str, default=None, help="Project name in wandb")
